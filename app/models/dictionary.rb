...
class Dictionary < ActiveRecord::Base
  def self.found?(word)
    ...
    common_verbs = ['get','got','gotten','wait','go','waiting','going','gone','goes','really','is','am','are','was','were','be','being','try','trying','tried','tries','put','puts','feel','feels','felt','feeling','will','would','show','know','known','need','needed','showed','say','says','said','saying','see','sees','seen','be','can','use','used','could','using','should','see','saw','seeing','sort']
